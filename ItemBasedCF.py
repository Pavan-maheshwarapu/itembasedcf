...
ratings = pd.read_csv('C:/MLprojects/u.data', sep='\t', names=r_cols, usecols=range(3), encoding="ISO-8859-1")

m_cols = ['movie_id', 'title']
movies = pd.read_csv('C:/MLprojects/u.item', sep='|', names=m_cols, usecols=range(2), encoding="ISO-8859-1")
